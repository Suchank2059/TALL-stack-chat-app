<div x-data="{ type: 'all' }" class="flex flex-col transition-all h-full w-full overflow-hidden">
    <header class="px-3 z-10 bg_white sticky top-0 w-full py-2">
    ...
    <main class="overflow-y-scroll overflow-hidden h-full grow relative" style="contain:content">
        <ul class="p-2 grid w-full space-y-2">
            <li
                ...
                <aside class="grid grid-cols-12 w-full">
                    <a href="#"
                        class="col-span-12 border-b pb-2 border-gray-200 relative overflow-hidden truncate leading-5 w-full flex-nowrap p-1">
                        ...
                        <div class="flex gap-x-2 items-center">
                            ...
                            <p class="grow truncate text-sm font-[100]">Lorem ipsum dolor sit amet consectetur,
                                adipisicing elit. Culpa dolorum, quidem nobis magni quis molestias quod repellendus!
                                Harum facilis quas nam, modi quisquam velit cumque? Optio corrupti incidunt quaerat
                                minus?
                            </p>
                    ...
                    <div class="col-span-11 flex flex-col text-center my-auto">
